/*
    ...
    l’Esercizio 5 di E7 ) della forma 𝑎𝑥^2 + 𝑏𝑥 + 𝑐 = 0 in base alle seguenti indicazioni. La funzione riceve
    ...
    Scrivere poi un programma che fa inserire all'utente i coefficienti di un'equazione di secondo grado
    e stampa le sue soluzioni se queste sono reali e un opportuno messaggio in caso contrario.
